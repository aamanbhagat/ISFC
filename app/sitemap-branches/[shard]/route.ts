import { branchesSitemapXml, XML_HEADERS } from '@/lib/sitemap-xml';

export const revalidate = 86400;
export const dynamicParams = true;

// Matches /sitemap-branches/0.xml — the shard segment arrives as "0.xml".
export async function GET(
  ...
  const xml = await branchesSitemapXml(n);
